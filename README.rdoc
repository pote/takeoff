= ShowOff Presentation Software - Airplay Fork
...
Aguirre and maintained at https://github.com/elcuervo/airplay so that Showoff
...
and setup script will be required, I'll write that soon enough so that the
installation process is actually doable (I'll still be too messy for my taste)

Anyway, thanks for paying attention to this little fork, stay tuned for
updates, which should be coming soon :)
...
=======
>>>>>>> dd672170824864181ccea05234fc2871fccf008d
